...
wt.yaw = 0.
wt.tilt = 5.0/180*np.pi
wt.cone = 2.5/180*np.pi
...
wind = WindBox.construct(wt, wt_file, t_max, delta_t*10, 8.0, turbulence_generator=None, shear_format='power_law', alpha=0.2, t_ramp=0., seed=seed)
